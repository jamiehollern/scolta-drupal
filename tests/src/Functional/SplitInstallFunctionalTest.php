 ...
 *   build step and no access to anyone's content source.
...
class SplitInstallFunctionalTest extends BrowserTestBase {
   ...
   * {@inheritdoc}
   */
  protected static $modules = ['scolta', 'scolta_ui', 'block'];
  ...
  public function testBothModulesGiveTheWholeSurface(): void {
    ...
    // keys — the property scolta_update_10009() gives an upgrading site, here
