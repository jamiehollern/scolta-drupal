...
(function (global) {
  ...
  // Scolta.setFilterRenderer(). Same lifecycle and rationale as the result
  // renderer above: a platform that themes its result cards almost always needs
  // to theme the facet list beside them, and neither can travel as config.
